...
class OISCandidateClient:
    ...
    def get_status(self):
        ...
        self.status = self.status + " 单位: %s" % self.setting["interviewerOrder"][0:2]
    ...
    def load_login_frame(self):
        ...
        self.login_frame_set["notice_textvar"].set("本机对应单位编号：%s" % self.setting["interviewerOrder"][0:2])
        ...
        self.login_frame_set["author"] = ttk.Label(self.login_frame_set["frame"], text="Developed By Lanzhijiang", anchor=CENTER, foreground="lightblue", background="red")
    ...
    def load_interview_info_frame(self):
        ...
        if user_interview_info is False:
            self.log.add_log("OISCandidateClient: load interview info frame failed, get user_interview_info failed", 3)
        ...
        self.interview_info_frame_set["order"] = ttk.Label(self.main_frame_set["interview_info_frame"], text="应聘编号：%s" % user_interview_info["code"], anchor=LEFT)
        self.interview_info_frame_set["order"].grid(column=0, row=3)
        self.interview_info_frame_set["apply_enterprise"] = ttk.Label(self.main_frame_set["interview_info_frame"],
                                                           text="应聘编号：%s" % user_interview_info["applyEnterprise"], anchor=LEFT)
        self.interview_info_frame_set["apply_enterprise"].grid(column=0, row=4)
        ...
        self.interview_info_frame_set["enterprise_name"] = ttk.Label(self.main_frame_set["interview_info_frame"],
                                                                     ...
                                                                     anchor=RIGHT)
        self.interview_info_frame_set["enterprise_name"].grid(column=0, row=5)
        ...
        self.interview_info_frame_set["now_for_job"] = ttk.Label(self.main_frame_set["interview_info_frame"],
                                                                 ...
                                                                 anchor=RIGHT)
        self.interview_info_frame_set["now_for_job"].grid(column=0, row=6)

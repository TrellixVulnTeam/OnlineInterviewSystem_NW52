...
class OISCandidateClient:
    ...
    def load_main_frame(self):
        ...
        self.main_frame_set["open_meeting_room"] = ttk.Button(self.main_frame_set["frame"], text="进入会议室",
        ...
        self.main_frame_set["author"].grid(column=1, row=9)
    ...
    def button_open_meeting_room_handle(self):
        ...
        self.main_frame_set["notice_textvar"].set("密码是%s加上您的手机号后四位；进入后不要退出" % self.setting["bindComCode"])
        ...
        while True:
            ...
            if res is False and err != "success":
                ...
                if res:
                    ...
                    time.sleep(2.5)
                    self.main_frame_set["notice_textvar"].set("终端将会自动退出，请不要关闭。")
                    time.sleep(2.5)
